...
class ReminderService {
  ...
  Future<void> _scheduleSingleNotification(
    ...
    if (scheduledDate.isBefore(DateTime.now())) {
      ...
      // Note: flutter_local_notifications requires platform-specific scheduling
      // For Android, we can use AndroidAlarmManager or WorkManager
      // For iOS, we can use local notifications with time interval
      // For simplicity, we'll use show() with a delay calculation
      final delay = scheduledDate.difference(DateTime.now());

      // Store the reminder for later triggering
      // In a production app, this would use platform-specific scheduling
